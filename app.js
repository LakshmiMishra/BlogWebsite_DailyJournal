...
//  let match=lodash.filter(posts,{'postTitle':postName});
posts.forEach(function(post){
  const postName=_.lowerCase(post.postTitle);
  if(_.lowerCase(requestedTitle) === postName){
    res.render("post",{"postTitle":post.postTitle,"postCont":post.postContent});
  }
});
});
